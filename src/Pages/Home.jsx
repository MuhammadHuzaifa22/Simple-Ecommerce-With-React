      ...
      <div className="hero-content flex flex-col  items-center text-center md:text-left">
        ...
        <div className="md:mr-8 mb-6 md:mb-0">
          <h1 className="text-5xl font-bold text-white mb-4">
            Welcome to AppleNest
          </h1>
          <p className="text-lg text-gray-300">
            Discover our exclusive collection of products and shop with ease.
          </p>
        </div>

        {/* Hero Button */}
        <div>
        <button className="px-8 py-3 bg-gradient-to-r from-green-400 to-blue-500 text-white font-semibold rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-110 hover:shadow-xl hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400">
  Shop Now
</button>
